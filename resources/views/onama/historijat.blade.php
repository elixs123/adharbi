...
<main id="main">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6" data-aos="fade-right" style="padding: 0;margin:0">
                <div class="image">
                    <img src="{{asset('img/historijat0.jpg')}}" style="width:100%;"  alt="{{asset('img/historijat0.jpg')}}">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="image">
                    <img src="{{asset('img/historijat1.jpg')}}" style="width:100%; height:50%;"  alt="">
                </div>
            </div>
        </div>
    </div>
